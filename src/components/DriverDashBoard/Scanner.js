      ...
      {showLocationInput && (
        <div style={{
          ...
          <div style={{ 
            ...
            <h3 style={{ margin: 0, color: '#1c6954', fontSize: '1.4em' }}>Barcode Scanned Successfully!</h3>
          </div>
          ...
          <div style={{ 
            ...
            <p style={{ margin: '0 0 8px 0', fontSize: '0.9em', color: '#666', fontWeight: '600' }}>
              Scanned Barcode:
            </p>
            <p style={{ margin: 0, fontSize: '1.2em', fontWeight: 'bold', color: '#1c6954' }}>
              {scannedBarcode}
            </p>
          </div>
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            <button
              ...
              onMouseOver={(e) => e.target.style.background = '#155c47'}
              onMouseOut={(e) => e.target.style.background = '#1c6954'}
            >
              💾 Save to Database
            </button>
            <button
      ...
      {!cameraActive && (
        <div style={{ 
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <h3 style={{ margin: '0 0 0.5rem 0', color: '#495057' }}>Camera Paused</h3>
            <p style={{ margin: 0, color: '#6c757d' }}>Please complete the sample details above</p>
          </div>
        </div>
      )}
